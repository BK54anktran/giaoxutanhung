    ...
    <div class="row" style="margin-bottom: 0;">
      <div id="content" class="col-sm-8">
        <div class="content_custom">
          <p>
            <img src="./Giáo xứ Tân Hưng_files/LadyRosaryVs.gif" alt="" style="width:100%; height:auto;">
          </p>
        </div>
        <div class="box type2" style="margin-top: 30px;">
          ...
          <div class="box-content">
            <div class="row" id="news-list" style="margin-left:0; margin-right:0; display:flex; flex-wrap:wrap;">
              <?php if (empty($items)): ?>
                  ...
                  <div class="col-sm-6 row1" style="display:flex; flex-direction:column;">
                    <a href="<?= h($href) ?>" class="image">
                      <img src="<?= h($image) ?>" class="img-responsive"
                        style="width:100%; height:200px; object-fit:cover; object-position:top;" alt="<?= h($title) ?>">
                    </a>
